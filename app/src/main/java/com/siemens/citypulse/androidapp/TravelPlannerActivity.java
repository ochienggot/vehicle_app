...
import com.siemens.citypulse.androidapp.common.DatabaseConnection;
import com.siemens.citypulse.androidapp.common.DefaultValues;
import com.siemens.citypulse.androidapp.common.GeocodeLocationTask;
...
//    private static LatLng[] mTraveler_locations = new LatLng[10];
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final ArrayAdapter<String> itemsAdapter = new ArrayAdapter<>(getActivity(),
                R.layout.list_item_text_view, pickupPoints);
        ...
        fab.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(getContext(),
                        "Using next pick-up point as the destination...",
                        Toast.LENGTH_LONG)
                        .show();
            }
        });
	...
	private String generateTravelPlannerRequest() {
